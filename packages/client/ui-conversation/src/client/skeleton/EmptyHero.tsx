// Hero chrome for the blank-draft phase of ConversationRoot: ant headline,
...
import {
  AntLogo, IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* The product ant mark leads the headline in a stationary hover box. */}
          <span className={css.markHitbox}>
            <AntLogo size={34} className={css.mark} />
          </span>
