...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-chico-price-series': { kind: 'none', reason: 'Browser-side rendering of a settled call\'s price-series render intent; dsh-tool-market-data owns the model-facing behavior.' },
