...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  followedNames: 'followed-names.md',
  marketData: 'market-data.md',
  nameRecord: 'name-record.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  investingFocus: 'client-side read-only open-name selection — packages/client/ui-watchlist/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FollowedName: 'followed-names.md',
  InstrumentMatch: 'market-data.md',
  InstrumentRef: 'market-data.md',
  InstrumentSearchRequest: 'market-data.md',
  InstrumentSearchResult: 'market-data.md',
  MarketDataProvider: 'market-data.md',
  PriceHistory: 'market-data.md',
  ...
  WatchlistSnapshot: 'watchlist.md',
