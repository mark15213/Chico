...
| `ctx.marketData` | `seam` | [`market-data`](../packages/investment/market-data) | [`market-data-fixture`](../packages/investment/market-data-fixture) | - | - | 报价和历史行情提供方注册到同一个 ctx.marketData seam；选择在每次调用时解析，因此失去权限会立即停止被选中而无需重新注册。 |
