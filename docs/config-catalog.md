...
Requires: `marketData` · `credentials`
...
Requires: `tools` · `marketData` · `systemPrompt`
...
Source: [`packages/investment/tool-market-data/src/index.ts:34`](../packages/investment/tool-market-data/src/index.ts)
...
- `@deepseek-ai/dsh-name-record` — requires `storageDomain` ([`packages/investment/name-record/src/index.ts`](../packages/investment/name-record/src/index.ts))
...
- `@deepseek-ai/dsh-watchlist` — requires `followedNames` · `marketData` · `nameRecord` ([`packages/investment/watchlist/src/index.ts`](../packages/investment/watchlist/src/index.ts))
